...
export default function GroupElement({group,setSelectedGroup}){
    return (
        <div className={style.groupElement}>
            <div className={style.groupName}>{group.name}</div>
            <div className={style.groupContainer}>
                <button className={style.invite}onClick={()=>setSelectedGroup(group)}><img src={'/group/invite.svg'}/>초대</button>
